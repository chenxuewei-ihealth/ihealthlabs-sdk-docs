...
<HashChange
  onLoad={() => {
    const topLink = document.querySelector(
      'a.menu__link[href="/docs/home/intro"]'
    );
    if (topLink) {
      topLink.onclick = (e) => {
        document
...
<GridLink
  to="/ihealthlabs-sdk-docs/docs/android/quickstart"
  title="Android"
  subtitle="Java"
...
<GridLink
  to="/ihealthlabs-sdk-docs/docs/ios/quickstart"
  title="iOS"
...
<GridLink
  to="/ihealthlabs-sdk-docs/docs/react-native/quickstart"
  title="React Native"
