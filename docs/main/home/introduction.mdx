...
<div className="grid xl:grid-cols-3">
  <div className="xl:col-span-1">
    <img src="../../../static/img/doc_index_1.png" style={{ width: 200, height: 150 }} />
  </div>
  <div className="xl:col-span-1">
    <img src="../../../static/img/doc_index_2.png" style={{ width: 200, height: 150 }} />
  </div>
  <div className="xl:col-span-1">
    <img src="../../../static/img/doc_index_3.png" style={{ width: 200, height: 150 }} />
  </div>
</div>
