...
:::info
Call the API once, the watch only vibrates 6 times for about 5 seconds.
So if you want to achieve continuous vibration, please continue to call the API after 5 seconds.
:::
